      ...
      >
        ...
        <div className="d-flex justify-content-center">
          <select
            ...
            onChange={handlePrNameFromRevisinChange}
          >
        ...
        <div className="d-flex justify-content-center">
          <select
            className="form-select text-center"
            onChange={handleRevisinChange}
          >
            <option>Choose revision:</option>
            {revision.revision.map((el, ind) => {
        ...
        <div className="col">
          <label className="">Revision :</label>
          <div className="card col text-center bg-primary-subtle">
            <label className="pb-1 pt-1">{rev ? rev : "Not value"}</label>
          </div>
        </div>
